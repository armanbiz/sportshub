/*
  ...
  1. Changes
    - Insert gym data from Excel file
    - Add opening hours for each gym
    - Add amenities for each gym
    - Add classes for each gym

  2. Data Structure
    - Main gym information in gyms table
    - Operating hours in gym_hours table
...
SELECT id, 'Monday', '06:00', '22:00' FROM gyms WHERE name = 'Form Factory Smíchov'
UNION ALL
SELECT id, 'Tuesday', '06:00', '22:00' FROM gyms WHERE name = 'Form Factory Smíchov'
UNION ALL
SELECT id, 'Wednesday', '06:00', '22:00' FROM gyms WHERE name = 'Form Factory Smíchov'
UNION ALL
SELECT id, 'Monday', '06:00', '23:00' FROM gyms WHERE name = 'WorldClass Wenceslas Square'
UNION ALL
SELECT id, 'Tuesday', '06:00', '23:00' FROM gyms WHERE name = 'WorldClass Wenceslas Square'
UNION ALL
SELECT id, 'Wednesday', '06:00', '23:00' FROM gyms WHERE name = 'WorldClass Wenceslas Square'
UNION ALL
SELECT id, 'Monday', '07:00', '21:00' FROM gyms WHERE name = 'Yoga Karlin'
UNION ALL
SELECT id, 'Tuesday', '07:00', '21:00' FROM gyms WHERE name = 'Yoga Karlin'
UNION ALL
SELECT id, 'Wednesday', '07:00', '21:00' FROM gyms WHERE name = 'Yoga Karlin'
UNION ALL
SELECT id, 'Monday', '06:30', '21:30' FROM gyms WHERE name = 'CrossFit Committed'
UNION ALL
SELECT id, 'Tuesday', '06:30', '21:30' FROM gyms WHERE name = 'CrossFit Committed'
UNION ALL
SELECT id, 'Wednesday', '06:30', '21:30' FROM gyms WHERE name = 'CrossFit Committed'
UNION ALL
SELECT id, 'Monday', '06:00', '22:00' FROM gyms WHERE name = 'Pure Jatomi Fitness Harfa'
UNION ALL
SELECT id, 'Tuesday', '06:00', '22:00' FROM gyms WHERE name = 'Pure Jatomi Fitness Harfa'
UNION ALL
SELECT id, 'Wednesday', '06:00', '22:00' FROM gyms WHERE name = 'Pure Jatomi Fitness Harfa';
