        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {NEIGHBORHOODS.map((neighborhood) => (
            <AnimatedSection
              ...
              className="group relative overflow-hidden rounded-xl bg-dark-card border border-white/10 hover:border-neon-green/40 transition-all duration-300"
            >
              <div className="p-6">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-gray-400">{neighborhood.count} gyms</span>
                </div>
              </div>
